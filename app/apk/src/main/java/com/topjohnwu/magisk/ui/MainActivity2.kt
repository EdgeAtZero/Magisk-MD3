...
class MainActivity2 : NavigationActivity<ActivityMainMd2Binding>(), SplashScreenHost {
                    ...
                    withPermission(REQUEST_INSTALL_PACKAGES) {
                        if (!it) {
                            ...
                            lifecycleScope.launch {
                                AppMigration.restore(this@MainActivity2)
                            }
                        }
                    }
                }
        ...
        if (isRunningAsStub && !Config.askedHome &&
            ...
            MagiskDialog(this).apply {
                ...
                setButton(MagiskDialog.ButtonType.POSITIVE) {
                    ...
                    onClick {
                        Shortcuts.addHomeIcon(this@MainActivity2)
                    }
                }
                setCancelable(true)
            }.show()
